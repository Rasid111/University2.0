...
namespace UniversityWebapi.Migrations
{
    ...
    [Migration("20250528093821_Change profile relations to 1x1")]
    partial class Changeprofilerelationsto1x1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UniversityWebapi.Models.StudentProfile", b =>
                {
                    ...
                    b.HasOne("UniversityWebapi.Models.User", "User")
                        .WithOne("StudentProfile")
                        .HasForeignKey("UniversityWebapi.Models.StudentProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UniversityWebapi.Models.TeacherProfile", b =>
                {
                    ...
                    b.HasOne("UniversityWebapi.Models.User", "User")
                        ...
                        .HasForeignKey("UniversityWebapi.Models.TeacherProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
