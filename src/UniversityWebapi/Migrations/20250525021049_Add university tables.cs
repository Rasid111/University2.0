...
{
    /// <inheritdoc />
    public partial class Adduniversitytables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherProfiles_Faculties_FacultyId",
                        column: x => x.FacultyId,
                        principalTable: "Faculties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeachingAssignments_TeacherProfiles_TeacherProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentTeacherFeedbacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentTeacherFeedbacks_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentTeacherFeedbacks_TeacherProfiles_TeacherProfileId",
                        column: x => x.TeacherProfileId,
                        principalTable: "TeacherProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherStudentFeedbacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeacherStudentFeedbacks_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherStudentFeedbacks_TeacherProfiles_TeacherProfileId",
                        column: x => x.TeacherProfileId,
                        principalTable: "TeacherProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Homeworks_TeachingAssignments_TeachingAssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleElements_TeachingAssignments_TeachingAssignmentId",
                        column: x => x.TeachingAssignmentId,
                        principalTable: "TeachingAssignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tests_TeachingAssignments_TeachingAssignmentId",
                        column: x => x.TeachingAssignmentId,
                        principalTable: "TeachingAssignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeworkStatus = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentHomework_Homeworks_HomeworkId",
                        column: x => x.HomeworkId,
                        principalTable: "Homeworks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentHomework_StudentProfiles_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentProfileId = table.Column<int>(type: "integer", nullable: false),
                    ScheduleElementId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attendances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Attendances_ScheduleElements_ScheduleElementId",
                        column: x => x.ScheduleElementId,
                        principalTable: "ScheduleElements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_ScheduleElements_ScheduleElementId",
                        column: x => x.ScheduleElementId,
                        principalTable: "ScheduleElements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Title = table.Column<string>(type: "text", nullable: false),
                    CorrectAnswerTitle = table.Column<string>(type: "text", nullable: false),
                    PictureUrl = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionAnswer_Questions_TestQuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentAnswers_TestResults_TestResultId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_ScheduleElementId",
                table: "Attendances",
                column: "ScheduleElementId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_ScheduleElementId",
                table: "Grades",
                column: "ScheduleElementId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Homeworks_TeachingAssignmentId",
                table: "Homeworks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleElements_TeachingAssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAnswers_TestResultId",
                table: "StudentAnswers",
                column: "TestResultId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentHomework_StudentProfileId",
                table: "StudentHomework",
                column: "StudentProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentTeacherFeedbacks_StudentProfileId",
                table: "StudentTeacherFeedbacks",
                column: "StudentProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentTeacherFeedbacks_TeacherProfileId",
                table: "StudentTeacherFeedbacks",
                column: "TeacherProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherProfiles_FacultyId",
                table: "TeacherProfiles",
                column: "FacultyId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherStudentFeedbacks_StudentProfileId",
                table: "TeacherStudentFeedbacks",
                column: "StudentProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherStudentFeedbacks_TeacherProfileId",
                table: "TeacherStudentFeedbacks",
                column: "TeacherProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeachingAssignments_TeacherProfileId",
                table: "TeachingAssignments",
                column: "TeacherProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tests_TeachingAssignmentId",
                table: "Tests",
                column: "TeachingAssignmentId");
